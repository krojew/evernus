...
bool QDropbox2::createAPIv2Request(QUrl request, QNetworkRequest& req, bool include_bearer)
{
    bool result = false;
...
bool QDropbox2::requestTokenViaOAuth1(QNetworkReply*& reply)
{
    ...
    QNetworkRequest req;
    if(!createAPIv2Request(url, req, false))
        return false;
