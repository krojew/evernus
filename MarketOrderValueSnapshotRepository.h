...
namespace Evernus
{
    ...
    private:
        ...
        virtual void bindValues(const MarketOrderValueSnapshot &entity, QSqlQuery &query) const override;
        virtual void bindPositionalValues(const MarketOrderValueSnapshot &entity, QSqlQuery &query) const override;
    };
}
