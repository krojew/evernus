...
namespace Evernus
{
        ...
        , mDataModel(dataProvider)
    {
        ...
        connect(filterBtn, &QPushButton::clicked, this, &ScrapmetalReprocessingArbitrageWidget::recalculateData);
        ...
        mDataView = new AdjustableTableView{QStringLiteral("marketAnalysisScrapmetalReprocessingArbitrageView"), this};
    ...
    void ScrapmetalReprocessingArbitrageWidget::setCharacter(std::shared_ptr<Character> character)
    {
    ...
    void ScrapmetalReprocessingArbitrageWidget::clearData()
    {
        mDataModel.reset();
    }

    void ScrapmetalReprocessingArbitrageWidget::setPriceType(PriceType dst) noexcept
    {
        mDstPriceType = dst;
    }

    void ScrapmetalReprocessingArbitrageWidget::recalculateData()
    {
        qDebug() << "Recomputing Scrapmetal reprocessing arbitrage data...";
    ...
    void ScrapmetalReprocessingArbitrageWidget::changeStation(quint64 &destination, const QVariantList &path, const QString &settingName)
    {
        QSettings settings;
