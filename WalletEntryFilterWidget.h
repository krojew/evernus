...
namespace Evernus
{
    ...
    signals:
        void filterChanged(const QDate &from, const QDate &to, const QString &filter, int type);

    public slots:
        void setFilter(const QDate &from, const QDate &to, const QString &filter, int type);
