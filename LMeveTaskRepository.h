...
namespace Evernus
{
    class LMeveTaskRepository
        : public Repository<LMeveTask>
    {
    public:
        using Repository::Repository;
        virtual ~LMeveTaskRepository() = default;
    ...
    private:
        ...
        virtual void bindPositionalValues(const LMeveTask &entity, QSqlQuery &query) const override;
    };
}
